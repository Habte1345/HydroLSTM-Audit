...
def main(csv_file):
    ...
    mapping_json_path = r"/bighome/hdagne1/NFDI4Earth-HydroTurtle/mappings/camels_gb_mapping.json" #input("Enter the path of the Mapping JSON file: ") - mapping JSON file
    prefixes_json_path =r"/bighome/hdagne1/NFDI4Earth-HydroTurtle/mappings/rdf_prefixes.json" #input("Enter the path of the Prefixes JSON file: ") - prefixes dict
    time_data_json_path = r"/bighome/hdagne1/NFDI4Earth-HydroTurtle/mappings/mapping_time.json"  # Time Json file
    ...
    csv_file_name = os.path.basename(csv_file_path)
    extracted_id = csv_file_name.replace(".csv", "")
...
if __name__ == "__main__":
    ...
    dir_path = dir_path = r'/bighome/hdagne1/NFDI4Earth-HydroTurtle/camels/*.csv'

    from tqdm import tqdm

    file_list = glob.glob(r'/bighome/hdagne1/NFDI4Earth-HydroTurtle/camels/*.csv')

    for csv_file in tqdm(file_list, desc="Converting CAMELS basins", unit="basin"):
        main(csv_file)

    print("✅ All 482 basins converted successfully.")
